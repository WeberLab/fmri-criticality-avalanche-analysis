...
%% calculate the MS and SE using HY48 vox-wise signals
% setting
clc; clear; close all;

%set the voxcel siganls path
%set the file folder
F_F = 'step_1\voxcel_signals\HY_48';
...
% for SUB=1:295 %CHNAGE IT BACK LATER ON as rn we only have 1 subject
for SUB=1
    for ROI=1:48 % we have 48 ROIs, not 96
        ...
        load(VOX_s_p);
        clear signals
        signals = RS_HY_48_voxceL_signals';
        clear RS_HY_48_voxceL_signals
...
save('MS_SE_HY48_ROI.mat','syn','synE','subject');